      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            expCookie = res.data.cookieOptions.expires;
            document.cookie = "jwt=".concat(token, "; expires=").concat(expCookie);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status = 'success') {
              expCookie = res.data.cookieOptions.expires;
              document.cookie = "jwt=; expires=".concat(expCookie);
...
var stripe = Stripe('pk_test_51JSNkUSI2qB0FZvWS0iwKPhqZcDky3SnCwReUek5SNfbuyZrSI8Qnm1M6lGYcZjnObCQtziqxrDpvzJlcti1nU6M00IQ5cY73m');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            test = document.cookie.split(';')[1].split('=')[1];
            console.log('book tour: ', test); //1. get checkout session from API

            _context.next = 5;
            return (0, _axios.default)("http://127.0.0.1:8000/api/v1/bookings/checkout-session/".concat(tourId, "/").concat(test));

          case 5:
            session = _context.sent;
            console.log('Session: ', session); //2. create checkout form + charge credit card
